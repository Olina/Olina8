...
function create_url($urlOrController=null, $method=null, $arguments=null) {
  return COlina::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
...
function theme_url($url) {
  return create_url(COlina::Instance()->themeUrl . "/{$url}");
}
...
function theme_parent_url($url) {
  return create_url(COlina::Instance()->themeParentUrl . "/{$url}");
}
...
function render_views($region='default') {
  return COlina::Instance()->views->Render($region);
}
...
function region_has_content($region='default' /*...*/) {
  return COlina::Instance()->views->RegionHasView(func_get_args());
}
